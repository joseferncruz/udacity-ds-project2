...
def return_figures():
    ...
    layout_two = dict(title='<b>Noise complaints in each NYC borough<b>',
                      barmode='group',
                      yaxis=dict(title='number of complaints'),)
    ...
    layout_three = dict(title='<b> Top 3 noise complaints<b>',
                        barmode='group',
...
# FIGURE 4
    ...
    layout_four = dict(title='<b>Type of noise complaints during the weekdays<b>',
                        barmode='stack',
